chess: ChessMain.o chessBoard.o piece.o pawn.o rook.o knight.o bishop.o queen.o king.o 
	g++ -Wall -g ChessMain.o chessBoard.o piece.o pawn.o rook.o knight.o bishop.o king.o queen.o -o chess
